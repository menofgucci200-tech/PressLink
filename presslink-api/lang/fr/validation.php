...
return [
    ...
    | utilisés par la classe Validator. Certaines règles ont plusieurs
    | versions, comme les règles de taille. N'hésitez pas à les adapter.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute donné a été compromis lors d\'une fuite de données. Veuillez choisir un autre :attribute.',
    ],
    ...
    */
    ...
    'custom' => [
        'phone' => [
            'regex' => 'Le numéro de téléphone doit être au format +2250XXXXXXXXX.',
            'required' => 'Le numéro de téléphone est obligatoire.',
            'unique' => 'Ce numéro de téléphone est déjà utilisé.',
        ],
        'login' => [
            'required' => 'L\'identifiant de connexion est obligatoire.',
            'unique' => 'Cet identifiant de connexion est déjà utilisé.',
            'regex' => 'L\'identifiant ne doit contenir que des lettres, chiffres, points, tirets ou underscores.',
        ],
        'password' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace le nom technique du champ (ex. "email") par un intitulé plus
    | lisible dans les messages d'erreur (ex. "adresse e-mail").
    |
    */
    ...
    'attributes' => [
        ...
        'ownerLogin' => 'login du propriétaire',
        ...
        'pressingRows' => 'pressings du groupe',
        'pressingRows.*.name' => 'nom du pressing',
        'pressingRows.*.code' => 'code du pressing',
        'pressingRows.*.phone' => 'téléphone du pressing',
        'pressingRows.*.city' => 'ville du pressing',
    ],
