                ...
                child: ElevatedButton.icon(
                  onPressed: () async {
                    final joined = await Navigator.of(context).push<bool>(
                      AppPageRoute(builder: (_) => const JoinPressingScreen()),
                    );
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                'Vous n\'avez rejoint aucun pressing.',
                              ),
                              const SizedBox(height: AppSpacing.sm),
                              TextButton(
                                onPressed: () async {
                              ...
                              onLeave: () async {
                                final confirmed = await showDialog<bool>(
                                  ...
                                  builder: (context) => AlertDialog(
                                    ...
                                    content: Text(
                                      'Vous ne verrez plus les commandes de ${pressing.name} associées à ce pressing.',
                                    ),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        PressingRepository.errorMessage(e),
                                      ),
                                    ),
                                  );
                                }
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: () => Navigator.of(context).push(
        AppPageRoute(builder: (_) => PressingDetailScreen(pressing: pressing)),
      ),
      child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    [
                      if (pressing.city != null) pressing.city!,
                      '${pressing.ordersCount} commande(s)',
                    ].join(' · '),
